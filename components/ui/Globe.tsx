...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  const groupRef = useRef<Group | null>(null); // Proper typing here
  ...
  useEffect(() => {
    if (!globeRef.current && groupRef.current) {
      ...
      groupRef.current.add(globeRef.current); // fixed here - groupRef is typed as THREE.Group
  ...
  }, [isInitialized, globeConfig.globeColor, globeConfig.emissive, globeConfig.emissiveIntensity, globeConfig.shininess, defaultProps.globeColor, defaultProps.emissive, defaultProps.emissiveIntensity, defaultProps.shininess]);
